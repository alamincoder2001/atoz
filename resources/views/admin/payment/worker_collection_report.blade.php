...
@section('title', 'Admin Worker Payment Collection Report')
@section('breadcrumb_title', 'Worker Payment Collection Report')
@section('breadcrumb_item', 'Worker Payment Collection Report')
