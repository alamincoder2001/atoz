...
@push('front_style')
    <style>
        ...
        #owl-example.owl-carousel.owl-drag .owl-item { width: 200px !important; }
        .single-listing-box .listing-badge { background-color: #863ed2; }
        .single-listing-box .listing-badge::before{ border-bottom: #863ed2; }
        .single-listing-item .listing-image .listing-tag a { color: #b654f1; }
        .single-listing-item .listing-image .listing-tag:hover { background-color: #863ed2 !important;}
        .single-listing-item:hover .listing-image .listing-tag, .single-listing-item:focus .listing-image .listing-tag { background-color: #863ed2 !important; }
        .single-listing-item .listing-discount span { background-color: #b756f2; }
        .single-listing-item .listing-discount span::before { background-color: #b756f2; }
        .single-listing-item .listing-discount span::after { background-color: #b756f2; }

        /* how it work and about section */
        .home-header p { color: rgba(0,0,0,.8); text-transform: uppercase; line-height: 1.29; position: relative; padding-left: 40px; font-weight: 500; }
        .home-header p:before { position: absolute; top: 8px; left: 0; content: ""; width: 30px; height: 1px; background-color: #979797; }
        .ccircle{ background-color: #c559f4; display: flex; color: #fff; justify-content: center; font-weight: 600; font-size: 25px; border-radius: 50%; }
        .list-group-flush>.list-group-item { border-width: 0 0 0 !important; padding: 10px 0 !important; }
        /* customer feedback button */
        .feedback-slides.owl-theme .owl-nav [class*=owl-]:hover, .feedback-slides.owl-theme .owl-nav [class*=owl-]:focus { background-color: #863ed252 !important;  }
...
@section('front_content')
    ...
    <div class="home-area" style="position: relative; height: 70vh;">
        <div class="home-slides owl-carousel owl-theme" style="position: relative; height: 60vh !important;">
            ...
            @endforeach
            {{-- <div class="hero-banner" style="background-image: url({{ asset('frontend/assets/img/slider-1.png') }});"></div>
                    ...
                    @foreach ($reviews as $review)
                        <div class="single-feedback-item">
                            ...
                            <div class="info">
                                ...
                                @if(isset($review->customer))
                                    <img src="{{ asset($review->customer->image != null ? $review->customer->image : 'nouser.png') }}" class="shadow rounded-circle"
                                    alt="image">
                                @endif
                            </div>
                        </div>
