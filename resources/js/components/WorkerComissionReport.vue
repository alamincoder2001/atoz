        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="" @click.prevent="print" :style="{ display: workerPayments.length > 0 ? '' : 'none' }"
                ...
                <div class="card-body pt-0" id="reportContent">
                    <table class="table table-bordered m-0 record-table" v-if="workerPayments.length > 0">
                        ...
                        <tbody>
                            <tr v-for="(item, sl) in workerPayments">
                                <td>{{ sl + 1 }}</td>
                                ...
                                <td>
                                    <a :href="`/admin/worker/payment-receive/${item.id}`" class="me-2 shadow-none"
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th>{{ workerPayments.reduce((prev, curr) => {return prev + parseFloat(curr.amount)}, 0).toFixed(2) }}</th>
                                <th></th>
                                <th></th>
                            </tr>
                        </tfoot>
...
export default {
    ...
    methods: {
        ...
        getCommission() {
            ...
            axios.post("/admin/get-worker-payment", formdata).then((res) => {
