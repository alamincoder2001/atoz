...
@push('front_style')
    ...
    <style>
        ...
        .select2-container--default .select2-selection--single { border: 1px solid #ac51f0 !important; height: 35px !important;}
                        ...
                        <div class="card-body customerRegister" style="padding:10px 40px 40px 40px;">
                            <form onsubmit="customerRegister(event)">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <select name="thana_id" class="thana_id getThana form-select selectTwo">
