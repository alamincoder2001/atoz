                    ...
                    <table class="table table-sm table-borderless">
                        <thead>
                            <tr>
                                ...
                                <th style="border-bottom: 1px dashed #ce5cf659;">Bill Amount</th>
                                <th style="border-bottom: 1px dashed #ce5cf659;">Due</th>
                                <th style="border-bottom: 1px dashed #ce5cf659;text-align:right;">Total</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <td align="right">
                                    {{ number_format(($orderDetail->bill_amount - $orderDetail->due), 2, ".", "") }}
                                </td>
                            </tr>
                        </tbody>
                    </table>
