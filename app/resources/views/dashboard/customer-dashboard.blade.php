...
@section('front_title', 'Customer Dashboard')
    @push('front_style')
        <style>
            .nav-pills .nav-link.active, .nav-pills .show>.nav-link { color: #fff !important; background-color: #da5bfe; }
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if($item->status == 'pending')
                                                        ...
                                                        <button title="Order Delete" onclick="OrderCancel({{$item->id}})" class="shadow-none text-white border-0" style="background: red;width:25px;height:22px;">X</button>
                                                    @endif
                                                </td>
                                            </tr>
                                            @endforeach
