...
@section('title', 'Worker Wise Order List')
@section('breadcrumb_title', 'Worker Wise Order List')
@section('breadcrumb_item', 'Worker Wise Order List')
                            ...
                            <form action="" method="GET">
                                ...
                                <div class="row g-3" style="height: 0;">
                                    ...
                                    <div class="col-auto">
                                        ...
                                        <a href="{{ url('admin/worker/wise/report', $worker->id) }}" title="Clear" class="btn btn-danger mb-3 cform mt-1" style="padding-top: 1px;">X</a>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <tbody>
                            @forelse ($orders as $key => $order)
                                <tr>
                                    ...
                                    <td style="text-align: end;">{{ $order->due }}</td>
